		...
		<body style="background: #121212; color: #ffffff; position: relative;">
			<header>
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					<div class="container">
						<img src="../img/icons/admin-icon.png" width="30" height="30" alt="Cut Your URL logo" style="margin-right: 10px;">
						<a class="navbar-brand" href="<?php echo get_url('admin.php');?>"><?php echo SITE_NAME;?> - Admin</a>
